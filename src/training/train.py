...
def train(args: argparse.Namespace):
    ...
    lr_scheduler = optim.lr_scheduler.StepLR(optimizer, args.lr_epochs, gamma=0.1)
    ...
    try:
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            lr_scheduler.step()
            logging.info(f"LR: {[_['lr'] for _ in optimizer.param_groups]}")
            # LR scheduler
...
if __name__ == '__main__':
    ...
    parser.add_argument('exp_dir', type=str,
                        default='./experiments/single_tse',
